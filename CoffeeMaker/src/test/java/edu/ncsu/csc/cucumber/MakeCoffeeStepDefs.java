...
public class MakeCoffeeStepDefs {
    ...
    public void initialInventory ( final int originalCoffee, final int originalMilk, final int originalSugar,
        ...
        makerData.originalCoffee = originalCoffee + 15;
        makerData.originalMilk = originalMilk + 15;
        makerData.originalSugar = originalSugar + 15;
        makerData.originalChocolate = originalChocolate + 15;
