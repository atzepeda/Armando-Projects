 ...
 * 
 * @author Sarah Heckman Shalini Balagopal Nick Macon
 */
public class StudentDirectoryTest {
	...
	/**
	 * Tests StudentDirectory() is empty
	 */
	@Test
	...
	public void testLoadStudentsFromFile() {
		...
		try {
			sd.loadStudentsFromFile("invalid_file");
	...
	public void testAddStudent() {
		...
		// tests Student is not added when new student ID matches ID of student in
		// directory already
		assertFalse(sd.addStudent("Zahir", "King", "sdent", "orci.Donec@ametmassaQuisque.com", "pw", "pw", 15));
	}
	...
	public void testgetStudentById() {
		...
		// Add a student
		sd.addStudent("Zahir", "King", "zking", "orci.Donec@ametmassaQuisque.com", "pw", "pw", 15);
		assertEquals("orci.Donec@ametmassaQuisque.com", sd.getStudentById("zking").getEmail());
	}
