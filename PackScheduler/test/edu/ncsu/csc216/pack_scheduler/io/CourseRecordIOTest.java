...
/**
 * Tests CourseRecordIO. Compares valid course records against actual course records
 * that are both read in and written to files by CourseRecordIO.
...
public class CourseRecordIOTest {
	 ...
	 * @throws IOException if unable to reset the file
	 */
	@Before
