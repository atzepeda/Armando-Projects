...
public class CourseTest {
	...
	public void testSetInstructorId() {
		...
		//Test that setting the instructor id to null is fine.
	...
	/**
	 * Tests that the course times are set correctly. (changed method name to setActivityTime)
	 */
	@Test
	...
	public void testEqualsObject() {
		...
		Course c3 = new Course(NAME, "Different", SECTION, CREDITS, INSTRUCTOR_ID, ENROLL_CAP, MEETING_DAYS, START_TIME, END_TIME);
		Course c4 = new Course(NAME, TITLE, "002", CREDITS, INSTRUCTOR_ID, ENROLL_CAP, MEETING_DAYS, START_TIME, END_TIME);
		Course c5 = new Course(NAME, TITLE, SECTION, 5, INSTRUCTOR_ID, ENROLL_CAP, MEETING_DAYS, START_TIME, END_TIME);
		Course c6 = new Course(NAME, TITLE, SECTION, CREDITS, "Different", ENROLL_CAP, MEETING_DAYS, START_TIME, END_TIME);
		...
		Course c9 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLL_CAP, MEETING_DAYS, START_TIME, 1400);
    ...
    public void testCompareTo() {
    		Course s1 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLL_CAP, MEETING_DAYS, START_TIME, END_TIME);
		Course s2 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLL_CAP, MEETING_DAYS, START_TIME, END_TIME);
		Course s3 = new Course("CSC226", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLL_CAP, MEETING_DAYS, START_TIME, END_TIME);
		Course s4 = new Course(NAME, TITLE, "002", CREDITS, INSTRUCTOR_ID, ENROLL_CAP, MEETING_DAYS, START_TIME, END_TIME);

		
		assertEquals(s2.compareTo(s1), 0); // checks two courses with same name and section number return 0
		assertEquals(s1.compareTo(s2), 0); // commutative check
		
		
        assertEquals(s2.compareTo(s3), -1); // s2 name is less than s3 section, so -1 is returned
        assertEquals(s3.compareTo(s2), 1); // 1 should be returned when order is switched

        assertEquals(s2.compareTo(s4), -1); // s2 section is less than s4 section, so -1 is returned
        assertEquals(s4.compareTo(s2), 1); // 1 should be returned when order is switched
