...
public class User extends DomainObject<User> implements Serializable {
    ...
    /**
     * Get the user by name and specialization
     *
     * @param name
     *            the username
     * @param specialization
     *            the specialization of the user
     * @return the user with this name and specialization
     */
    public static User getByNameAndSpecialization ( final String name, final Specialization specialization ) {
        final Vector<Criterion> criteria = new Vector<Criterion>();
        criteria.add( eq( "username", name ) );
        criteria.add( eq( "specialization", specialization ) );
        try {
            return getWhere( criteria ).get( 0 );
        }
        catch ( final Exception e ) {
    ...
    /**
     * Get all users with the passed specialization
     *
     * @param specialization
     *            the specialization to get the users of
     * @return the users with the passed specialization
     */
    public static List<User> getBySpecialization ( final Specialization specialization ) {
        return getWhere( eqList( "specialization", specialization ) );
    }
    ...
    /**
     * All-Argument-Except-Specialization constructor for User
     *
     * @param username
     *            Username
     * @param password
     ...
     *            1 if the user is enabled 0 if not
     */
    public User ( final String username, final String password, final Role role, final Specialization specialization,
    ...
    public User ( final UserForm form ) {
        ...
        if ( form.getSpecialization() != null ) {
            setSpecialization( Specialization.valueOf( form.getSpecialization() ) );
        }
    }
    ...
    /**
     * Get the specialization of this user
     *
     * @return the specialization of this user
     */
    ...
    /**
     * Set the specialization of this user
     *
     * @param specialization
     *            the specialization to set this user to
     */
