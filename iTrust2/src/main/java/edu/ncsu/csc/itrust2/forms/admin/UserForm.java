...
public class UserForm {
    ...
    /**
     * Create a UserForm from all of its fields except specialization.
     *
     * @param username
     ...
     *            Specialization of the new User
     * @param enabled
     *            Whether the new User is enabled or not
     *
     */
    public UserForm ( final String username, final String password, final String role, final String specialization,
     ...
     * @param specialization
     *            Specialization (Specialization Enum) of the new user
     * @param enabled
     *            Whether the user is enabled; 1 for enabled, 0 for disabled.
     */
    public UserForm ( final String username, final String password, final Role role,
            final Specialization specialization, final Integer enabled ) {
        this( username, password, role.toString(), specialization.toString(), enabled != 0 ? "true" : null );
    }
