...
public class LabProcedureTest {
    ...
    public void testGetBy () throws NumberFormatException, ParseException {
        ...
        visitForm.setAxisLeft( 1 );
        visitForm.setAxisRight( 2 );
        visitForm.setCylinderLeft( 3.0f );
        visitForm.setCylinderRight( 4.0f );
        visitForm.setSphereLeft( 5.0f );
        visitForm.setSphereRight( 6.0f );
        visitForm.setVisualAcuityLeft( 7.0f );
        visitForm.setVisualAcuityRight( 8.0f );
