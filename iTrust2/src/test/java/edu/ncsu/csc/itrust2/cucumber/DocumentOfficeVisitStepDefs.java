...
public class DocumentOfficeVisitStepDefs extends CucumberTest {
    ...
    public void personnelExists () throws Exception {
        ...
        DomainObject.deleteAll( OpticalHealthMetrics.class );
        ...
        final OfficeVisit surgeryVisit = new OfficeVisit();
        ...
        ohm.setHcp( User.getByName( "Ophthalmologist" ) );
        ohm.setPatient( User.getByName( "AliceThirteen" ) );
        ...
        surgeryVisit.setOpticalHealthMetrics( ohm );
        surgeryVisit.setType( AppointmentType.OPHTHALMOLOGY_SURGERY );
        surgeryVisit.setHospital( hospital );
        surgeryVisit.setPatient( User.getByName( "AliceThirteen" ) );
        surgeryVisit.setHcp( User.getByName( "Ophthalmologist" ) );
        surgeryVisit.setDate( Calendar.getInstance() );

        surgeryVisit.setSurgery( Surgeries.CATARACT_SURGERY );
    ...
    public void loginAsOphthalmologist () {
        driver.get( baseUrl );
        final WebElement username = driver.findElement( By.name( "username" ) );
        username.clear();
        username.sendKeys( "ophthalmologist" );
        final WebElement password = driver.findElement( By.name( "password" ) );
        password.clear();
        password.sendKeys( "123456" );
        final WebElement submit = driver.findElement( By.className( "btn" ) );
    ...
    public void loginAsOptometrist () {
        driver.get( baseUrl );
        final WebElement username = driver.findElement( By.name( "username" ) );
        username.clear();
        username.sendKeys( "optometrist" );
        final WebElement password = driver.findElement( By.name( "password" ) );
        password.clear();
        password.sendKeys( "123456" );
        final WebElement submit = driver.findElement( By.className( "btn" ) );
    ...
    public void navigateDocumentOV () {
        ...
        waitForAngular();
        driver.findElement( By.xpath( "//input[@value='GENERAL_CHECKUP']" ) ).click();
    }

    @When ( "I navigate to the Edit Office Visit page" )
    public void navigateEditOV () {
    ...
    public void documentGOV () {
        waitForAngular();
        driver.findElement( By.xpath( "//input[@value='OPHTHALMOLOGY_APPOINTMENT']" ) ).click();

        final WebElement notes = driver.findElement( By.name( "notes" ) );
        notes.clear();
        notes.sendKeys( "Patient needs brand new eyes" );
        ...
        final WebElement useBHM = driver.findElement( By.name( "useBHM" ) );
        useBHM.click();
        ...
        final WebElement visualAcuityLeft = driver.findElement( By.name( "visualAcuityLeft" ) );
        visualAcuityLeft.clear();
        visualAcuityLeft.sendKeys( "20" );

        final WebElement visualAcuityRight = driver.findElement( By.name( "visualAcuityRight" ) );
        visualAcuityRight.clear();
        visualAcuityRight.sendKeys( "20" );

        final WebElement sphereLeft = driver.findElement( By.name( "sphereLeft" ) );
        sphereLeft.clear();
        sphereLeft.sendKeys( "20" );

        final WebElement sphereRight = driver.findElement( By.name( "sphereRight" ) );
        sphereLeft.clear();
        sphereLeft.sendKeys( "20" );
    ...
    @Then ( "The office visit is edited successfully" )
    ...
    @When ( "I select an ophthalmology surgery office visit and change some values" )
    public void editOphthalmologySurgery () {
        waitForAngular();
        driver.findElement( By.name("specificVisit") ).click();

        waitForAngular();
        final WebElement visualAcuityLeft = driver.findElement( By.name( "visualAcuityLeft" ) );
        visualAcuityLeft.clear();
        visualAcuityLeft.sendKeys( "10" );

        final WebElement visualAcuityRight = driver.findElement( By.name( "visualAcuityRight" ) );
        visualAcuityRight.clear();
        visualAcuityRight.sendKeys( "10" );
    ...
    public void documentOphthalmologySurgery () {
        waitForAngular();
        driver.findElement( By.xpath( "//input[@value='OPHTHALMOLOGY_SURGERY']" ) ).click();

        final WebElement notes = driver.findElement( By.name( "notes" ) );
        notes.clear();
        notes.sendKeys( "Patient now has robot eyes" );
        ...
        waitForAngular();
        driver.findElement( By.xpath( "//input[@value='CATARACT_SURGERY']" ) ).click();
