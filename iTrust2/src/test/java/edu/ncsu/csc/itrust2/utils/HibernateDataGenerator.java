...
public class HibernateDataGenerator {
    ...
    /**
     * Generates the Ophthalmology diagnoses
     *
     * @throws ParseException
     * @throws NumberFormatException
     */
    public static void generateOphthalmologyDiagnoses () throws NumberFormatException, ParseException {

        ICDCodeForm codeForm = new ICDCodeForm();

        // Create Ophthalmology Diagnoses
        codeForm = new ICDCodeForm();
        codeForm.setCode( "C09" );
        codeForm.setDescription( "CATARACTS" );
        final ICDCode cataract = new ICDCode( codeForm );
        cataract.save();

        codeForm = new ICDCodeForm();
        codeForm.setCode( "C10" );
        codeForm.setDescription( "AGE-RELATED_MACULAR_DEGENERATION" );
        final ICDCode macularDegen = new ICDCode( codeForm );
        macularDegen.save();

        codeForm = new ICDCodeForm();
        codeForm.setCode( "C11" );
        codeForm.setDescription( "AMBLYOPIA" );
        final ICDCode amblyopia = new ICDCode( codeForm );
        amblyopia.save();

        codeForm = new ICDCodeForm();
        codeForm.setCode( "C12" );
