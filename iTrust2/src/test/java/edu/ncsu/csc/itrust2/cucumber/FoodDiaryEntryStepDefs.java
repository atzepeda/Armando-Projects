...
public class FoodDiaryEntryStepDefs extends CucumberTest {
    ...
    public void addEntry ( final String date, final String type, final String name, final int servings,
            final int calories, final int fat, final int sodium, final int carbs, final int sugars, final int fiber,
            final int protein ) {
        waitForAngular();
    ...
    public void incorrectlyAdd ( final String date, final String type, final String name, final String servings,
            final String calories, final String fat, final String sodium, final String carbs, final String sugars,
    ...
    public void addDiaryEntry ( final String date, final String type, final String name, final int servings,
            final int calories, final int fat, final int sodium, final int carbs, final int sugars, final int fiber,
            final int protein ) {
        loginPatientDiaries();
        requestAddDiaryPage();
    ...
    public void viewEntryPatient ( final String date, final String type, final String name, final int servings,
            final int calories, final int fat, final int sodium, final int carbs, final int sugars, final int fiber,
            final int protein ) {
    ...
    public void viewEntryHCP ( final String date, final String type, final String name, final int servings,
            final int calories, final int fat, final int sodium, final int carbs, final int sugars, final int fiber,
            final int protein ) throws Throwable {
        assertEquals( type, driver.findElement( By.id( "mealType-0" ) ).getText() );
        assertEquals( name, driver.findElement( By.id( "name-0" ) ).getText() );
        assertEquals( servings, Integer.parseInt( driver.findElement( By.id( "servings-0" ) ).getText() ) );
        assertEquals( calories, Integer.parseInt( driver.findElement( By.id( "calories-0" ) ).getText() ) );
    ...
    public void checkTotals ( final int calories, final int fat, final int sodium, final int carbs, final int sugars,
            final int fiber, final int protein ) {
        waitForAngular();
