 ...
 *
 * @author Josh Bloch
 * @author Neal Gafter see Collection see Set see ArrayList see LinkedList see
 *         Vector see Arrays#asList(Object[]) see Collections#nCopies(int,
 *         Object) see Collections#EMPTY_LIST see AbstractList see
